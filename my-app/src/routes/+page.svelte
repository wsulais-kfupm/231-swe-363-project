<script>
	...
	import HD from '$lib/assets/HD.png';
	import DP from '$lib/assets/DP.png';
...
<main class="inline-flex w-full flex-col items-start justify-start gap-8 px-8">
	<section class="category-container">
		<h1 class="font-['Inter'] font-sans text-5xl font-semibold leading-10 text-black">
			Popular Categories
		</h1>
		<section class="category-cards">
			<Category cname="Foods and Beverages" src={FB} color="blue" />
			<Category cname="Houshold" src={HD} color="green" />
			<Category cname="Disposables" src={DP} color="red" />
			<Category cname="Foods and Beverages" src={FB} color="blue" />
		</section>
		<div class="more-categories">
			<a style="display: flex; align-items:center; gap: var(--2, 8px);" href="'/">
				...
				>
					<path
						d="M12.6222 9.06666V12.5035C12.6223 12.6125 12.6009 12.7204 12.5592 12.8211C12.5175 12.9219 12.4564 13.0134 12.3793 13.0905C12.3022 13.1675 12.2107 13.2287 12.11 13.2703C12.0093 13.312 11.9013 13.3334 11.7923 13.3333H3.49649C3.38749 13.3334 3.27953 13.312 3.17881 13.2703C3.07808 13.2287 2.98656 13.1675 2.90948 13.0905C2.8324 13.0134 2.77128 12.9219 2.72961 12.8211C2.68793 12.7204 2.66653 12.6125 2.66663 12.5035V4.20763C2.66653 4.09863 2.68793 3.99067 2.72961 3.88995C2.77128 3.78922 2.8324 3.6977 2.90948 3.62062C2.98656 3.54354 3.07808 3.48242 3.17881 3.44075C3.27953 3.39908 3.38749 3.37767 3.49649 3.37777H6.7804M9.2316 2.66666H13.3333V6.76834M7.72334 8.27661L13.2544 2.74559"
						stroke="#1A56DB"
						stroke-width="2"
	...
	<section class="inline-flex w-full items-start justify-start gap-8">
		{#await getinfo()}
			<p>Loading...</p>
		{:then products}
